 ...
 100  format(2g16.8)
      open(11, file="../output/Brun.dat", status="unknown")
...
c
      c=1.d-8
      open(1, file="../output/U.dat", status="unknown")
      open(2, file="../output/V.dat", status="unknown")
      open(3, file="../output/W.dat", status="unknown")
      do j=1, N-1
       x=dom*j/dfloat(N)
       do k=1, 3
