...
c
      if(ioptions(1).eq.0) then  !output in intercomparison format
       open(40, file="../output/T.dat", status="unknown")
       open(41, file="../output/A1.dat", status="unknown")
       open(42, file="../output/B1.dat", status="unknown")
       open(43, file="../output/C1.dat", status="unknown")
       open(44, file="../output/D1.dat", status="unknown")
       open(45, file="../output/A2.dat", status="unknown")
       open(46, file="../output/B2.dat", status="unknown")
       open(47, file="../output/C2.dat", status="unknown")
       open(48, file="../output/D2.dat", status="unknown")
       open(49, file="../output/A3.dat", status="unknown")
       open(50, file="../output/B3.dat", status="unknown")
       open(51, file="../output/C3.dat", status="unknown")
       open(52, file="../output/D3.dat", status="unknown")
       open(53, file="../output/A4.dat", status="unknown")
       open(54, file="../output/B4.dat", status="unknown")
       open(55, file="../output/C4.dat", status="unknown")
       open(56, file="../output/D4.dat", status="unknown")
      endif
      if(ioptions(1).eq.1) then  !output in xmgrace format
       ...
       open(43, file="../output/C1.dat", status="unknown")
       open(44, file="../output/D1.dat", status="unknown")
       open(45, file="../output/E1.dat", status="unknown")
       open(46, file="../output/F1.dat", status="unknown")
       open(47, file="../output/G1.dat", status="unknown")
       open(51, file="../output/A2.dat", status="unknown")
       open(52, file="../output/B2.dat", status="unknown")
       open(53, file="../output/C2.dat", status="unknown")
       open(54, file="../output/D2.dat", status="unknown")
       open(55, file="../output/E2.dat", status="unknown")
       open(56, file="../output/F2.dat", status="unknown")
       open(57, file="../output/G2.dat", status="unknown")
       open(61, file="../output/A3.dat", status="unknown")
       open(62, file="../output/B3.dat", status="unknown")
       open(63, file="../output/C3.dat", status="unknown")
       open(64, file="../output/D3.dat", status="unknown")
       open(65, file="../output/E3.dat", status="unknown")
       open(66, file="../output/F3.dat", status="unknown")
       open(67, file="../output/G3.dat", status="unknown")
       open(71, file="../output/A4.dat", status="unknown")
       open(72, file="../output/B4.dat", status="unknown")
       open(73, file="../output/C4.dat", status="unknown")
       open(74, file="../output/D4.dat", status="unknown")
       open(75, file="../output/E4.dat", status="unknown")
       open(76, file="../output/F4.dat", status="unknown")
       open(77, file="../output/G4.dat", status="unknown")
      endif
       open(81, file="../output/H1.dat", status="unknown")
       open(82, file="../output/H2.dat", status="unknown")
       open(83, file="../output/H3.dat", status="unknown")
       open(84, file="../output/H4.dat", status="unknown")
       open(91, file="../output/I1.dat", status="unknown")
       open(92, file="../output/I2.dat", status="unknown")
       open(93, file="../output/I3.dat", status="unknown")
       open(94, file="../output/I4.dat", status="unknown")
c
